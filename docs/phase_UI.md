...
| UI-3 | Page Migration Batch A (Dashboard, Agent Chat, Settings) | Done | [ui-3-completion.md](./progress/ui-3-completion.md) |
...
*Document version: v2.3 (UI special phase track)*
*Created: 2026-03-03*
